...
import { Star, Truck, ShieldCheck, ArrowLeft, Heart, Minus, Plus, ShoppingCart } from "lucide-react"
...
export default function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <div className="container py-8">
      <Link href="/products" className="inline-flex items-center text-sm mb-6 hover:text-pink-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div>
          <div className="mb-6">
            ...
            <div className="text-2xl font-bold text-pink-600 mb-4">{formatCurrency(product.price)}</div>
            ...
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <div className="text-sm font-medium text-green-600">Còn hàng ({product.stock} sản phẩm)</div>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-pink-600 hover:bg-pink-700 flex-1">
        ...
        <Tabs defaultValue="description">
          ...
          <TabsContent value="description" className="py-6">
            <div className="prose max-w-none">
              ...
              <p>
                Lấy một lượng kem vừa đủ và thoa đều lên da mặt và cổ sau khi đã làm sạch và sử dụng toner. Vỗ nhẹ để
                kem thẩm thấu hoàn toàn vào da. Sử dụng hai lần mỗi ngày, sáng và tối.
              </p>
              <h3 className="text-lg font-medium mt-6 mb-4">Lưu ý</h3>
              <p>
                Tránh tiếp xúc với mắt. Nếu sản phẩm tiếp xúc với mắt, rửa sạch ngay bằng nước. Ngừng sử dụng nếu xuất
                hiện dấu hiệu kích ứng và tham khảo ý kiến bác sĩ.
              </p>
            </div>
          </TabsContent>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <span className="ml-2 text-sm font-medium">{product.rating} trên 5</span>
                    <span className="mx-2 text-gray-300">·</span>
                    <span className="text-sm text-gray-500">{product.reviewCount} đánh giá</span>
                  </div>
                </div>
                <Button className="bg-pink-600 hover:bg-pink-700">Viết đánh giá</Button>
              </div>
                ...
                {[1, 2, 3].map((review) => (
                  <div key={review} className="border-b pb-6">
                    ...
                    <p className="text-gray-600">
                      Sản phẩm rất tốt, da tôi cảm thấy mềm mịn và đủ ẩm sau khi sử dụng. Kết cấu kem nhẹ, thẩm thấu
                      nhanh và không gây nhờn rít. Sẽ tiếp tục mua lại!
                    </p>
                  </div>
                ))}
              </div>
